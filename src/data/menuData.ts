...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'br17', name: 'Smocha (Chapati/Smokie)', category: 'breakfast', price: 150, badge: 'Popular', description: 'Warm chapati wrapped around a smokie sausage with kachumbari', image: '/menu-items/Saved PICS/Chapati.jpg' },

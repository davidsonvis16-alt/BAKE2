...
const galleryImages = [
  ...
  { src: '/a good momento.jpeg.jpeg', alt: 'A warm café moment at BakeMart', category: 'moments', label: 'A good moment' },
  ...
  { src: '/good company.jpeg', alt: 'Friends enjoying a meal in the café', category: 'moments', label: 'Good company' },
